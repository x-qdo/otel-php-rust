...
jq -e '.arch == "x86_64" and .zend_module_abi == "no-debug-non-zts-20220829" and .php_version_id >= 80200 and .php_version_id < 80300' <<<"${abi}" >/dev/null
